...
#     """
#     Feedback on form data quality, gaps, and validation for the session.
#
#     After a user turn, call this for structured feedback on errors / shortfalls in captured data
#     (not the concierge’s next-question guidance).
#
#     Args:
